...
@section('content')
    <div class="relative flex items-center min-h-screen">
        ...
        <div class="continer mx-auto flex flex-col lg:flex-row items-center justify-center pb-40">
            <div class="text-center my-4 lg:my-0 lg:mx-4">
                <h1 class="text-black text-5xl lg:text-8xl dark:text-white font-bold">MINIBANK</h1>
                <h3 class="text-black text-3xl lg:text-5xl dark:text-white font-semibold">Minibank</h3>
            </div>
            <div
                class="flex flex-col gap-6 border border-solid border-slate-200 rounded-lg shadow-md shadow-slate-400 mt-10 p-4">
                ...
                <div class="group flex justify-center">
                    <a href=""
                        ...
                        <button type="submit"
                            class="text-white font-bold text-xl p-2 group-hover:font-semibold transition-all duration-200">Log
                            in</button>
                    </a>
                </div>
            </div>
