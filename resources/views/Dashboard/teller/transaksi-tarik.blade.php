        ...
        <div class="main-container">
            <div class="main-content">
                <div class="border border-solid border-slate-200 rounded-lg bg-white shadow-md shadow-slate-400 mt-10 p-4">
                    <form action="{{ url('teller/dashboard/transaksi/tarik') }}" method="POST" class="flex flex-col items-center">
                        @csrf
                        ...
                        <div class="h-8"></div>
                            <div class="group flex justify-center">
                                <div class="w-full h-10 bg-purple-700 text-center rounded-md group-hover:bg-purple-500 transition-all duration-200">
                                    <button type="submit" class="text-white font-bold text-xl p-2 group-hover:font-semibold transition-all duration-200">Tarik</button>
                                </div>
                            </div>
                        </div>
                    </form>
