    ...
    <div class="main-content">
        <div class="relative ml-12prc flex items-center min-h-screen">
            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/3 -translate-y-1/2">
                ...
                <div class="mb=2 text-4xl text-center font-black dark:text-white">CUSTOMER SERVICE</div>
                <div class="p-5"></div>
                <div class="container mx-auto flex gap-x-6">
                    <div class="text-sm border rounded-lg shadow-lg p-10 relative bg-white dark:bg-slate-800">
                        <div class="mb-5 flex justify-center items-center">
                            <i class="fa-solid fa-user-plus text-7xl text-purple-600 dark:text-indigo-600"></i>
                        </div>
                        <p>
                            Tambah Akun
                        </p>
                    ...
                    <div class="text-sm border rounded-lg shadow-lg p-10 relative bg-white dark:bg-slate-800">
                        <div class="mb-5 flex justify-center items-center">
                            <i class="fa-solid fa-credit-card text-7xl text-purple-600 dark:text-indigo-600"></i>
                        </div>
                        <p>
                            Daftar Rekening
                        </p>
