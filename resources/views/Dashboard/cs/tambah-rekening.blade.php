        ...
        <div class="main-container">
            <div class="main-content">
                <div class="border border-solid border-slate-200 rounded-lg bg-white shadow-md shadow-slate-400 mt-10 p-4">
                    <form action="{{ url('cs/dashboard/tambah/rekening') }}" method="POST" class="flex flex-col items-center">
                        @csrf
                        <div class="flex flex-row gap-6">
                            <div class="flex flex-col gap-1 w-80">
                                <label for="id_nasabah">
                                    <span class="text-lg font-semibold">Nama Nasabah<sup><strong class="text-red-500">*</strong></sup></span>
                                </label>
                                <select name="id_nasabah" id="id_nasabah" class="h-8 border border-solid border-slate-400 rounded-md text-sm focus:outline-none px-2" required>
                        ...
                        <div class="flex flex-row gap-6 mt-4">
                            <div class="flex flex-col gap-1 w-80">
                                <label for="saldo">
                                    <span class="text-lg font-semibold mr-1">Saldo Awal<sup><strong class="text-red-500">*</strong></sup></span><span class="text-xs text-red-500 font-semibold">(Saldo harus di atas Rp. 500.000)</span>
                                </label>
