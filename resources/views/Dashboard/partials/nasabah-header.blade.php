<div class="navbar-content">
    ...
    <div class="navbar-item-container group {{ Request::is('nasabah/dashboard/mutasi') ? 'active' : '' }}">
        <a id="navbar-content" href="{{ url('nasabah/dashboard/mutasi') }}" class="navbar-item-link transition-all-500">
